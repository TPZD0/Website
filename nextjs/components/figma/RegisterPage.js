        ...
        <div className="w-full max-w-md">
          <Card className="flex w-full flex-col gap-6 rounded-[32px] border-0 bg-white/90 p-10 shadow-[0px_24px_80px_rgba(15,23,42,0.12)] backdrop-blur">
            <div className="text-center">
              <h2 className="text-3xl font-semibold text-[#101431]" style={{ fontSize: '2.25rem' }}>
                Create Account
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left">
              <div className="space-y-2">
                <Label htmlFor="register-full-name" className="text-base font-medium text-[#101431]" style={{ fontSize: '1.125rem' }}>
                  Full Name
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="register-email" className="text-base font-medium text-[#101431]" style={{ fontSize: '1.125rem' }}>
                  Email
                </Label>
                <Input
                  id="register-email"
              ...
              <div className="space-y-2">
                <Label htmlFor="register-password" className="text-base font-medium text-[#101431]" style={{ fontSize: '1.125rem' }}>
                  Password
                </Label>
                <Input
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#E3E7F4] bg-white text-sm font-medium text-[#5F6683]" style={{ fontSize: '0.9375rem' }}>or</span>
              <span className="h-px flex-1 bg-[#E3E7F4]" />
            </div>
